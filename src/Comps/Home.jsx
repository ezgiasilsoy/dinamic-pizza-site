...
export default function Home(){
    ...
    return (
      <div className="bg-[#FAF7F2]">
            ...
            <img src="/iteration-2-images/icons/1.svg" alt="YENİ! Kore" />
            <span className="flex items-center">YENİ! Kore</span>
            </div>
         
           <div  className="flex-row flex ">
            <img src="/iteration-2-images/icons/2.svg" alt="Pizza" />
            <span className="flex items-center">Pizza</span>
               </div>
            <div  className="flex-row flex ">
            <img src="/iteration-2-images/icons/3.svg" alt="Burger" />
            <span className="flex items-center">Burger</span>
             </div>
            <div  className="flex-row flex ">
            <img src="/iteration-2-images/icons/4.svg" alt="Kızartmalar" />
            <span className="flex items-center">Kızartmalar</span>
            </div>
             <div  className="flex-row flex " >
            <img src="/iteration-2-images/icons/5.svg" alt="Fast food" />
            <span className="flex items-center">Fast food</span>
          </div>
          <div className="flex-row flex ">
            <img src="/iteration-2-images/icons/6.svg" alt="Gazlı İçecek" />
      ...
      <section className="flex flex-col md:flex-row justify-center items-center gap-2 mt-15" >
            ...
            <div className="bg-no-repeat bg-cover bg-[url(/iteration-2-images/cta/kart-1.png)] w-100 h-80">
              ...
              <div className="bg-no-repeat bg-cover ml-0 bg-[url(/iteration-2-images/cta/kart-2.png)] h-40 w-100">
              ...
              <div className="bg-no-repeat bg-cover bg-[url(/iteration-2-images/cta/kart-3.png)] h-40 w-100">
        ...
        <div className="flex flex-col md:flex-row gap-5"> 
          <button className="ml-7 mt-2 bg-white rounded-4xl font-[Barlow] text-center text-l text-black flex flex-row md:w-40 md:h-15 items-center ">
            <img className="pl-5" src="/iteration-2-images/icons/1.svg" alt="Ramen" />
          ...
          <button className="ml-7 mt-2 bg-[#292929] rounded-4xl font-[Barlow] text-center text-l text-black flex flex-row md:w-40 md:h-15 items-center" >
            <img className="pl-5" src="/iteration-2-images/icons/2.svg" alt="Pizza" />
          ...
          <button className="ml-7 mt-2 bg-white rounded-4xl font-[Barlow] text-center text-l text-black flex flex-row md:w-40 h-15 items-center ">
            <img className="pl-5" src="/iteration-2-images/icons/3.svg" alt="Burger" />
            <span className="pl-2">Burger</span>
          </button>
          <button className="ml-7 mt-2 bg-white rounded-4xl font-[Barlow] text-center text-l text-black flex flex-row md:w-40 md:h-15 items-center ">
            <img className="pl-5" src="/iteration-2-images/icons/4.svg" alt="French fries" />
            <span className="pl-2">French fries</span>
          </button>
          <button className="ml-7 mt-2 bg-white rounded-4xl font-[Barlow] text-center text-l text-black flex flex-row md:w-40 md:h-15 items-center ">
            <img className="pl-5" src="/iteration-2-images/icons/5.svg" alt="Fast food" />
            <span className="pl-2">Fast food</span>
          </button>
          <button className="ml-7 mt-2 bg-white rounded-4xl font-[Barlow] text-center text-l text-black flex flex-row md:w-40 md:h-15 items-center ">
            <img className="pl-5" src="/iteration-2-images/icons/6.svg" alt="Soft drinks" />
        ...
        <div className="flex flex-col md:flex-row justify-center items-center my-15 gap-10">
          ...
          <div className="flex  flex-col justify-center items-center rounded-3xl bg-white w-90 h-100">
            <img src="/iteration-2-images/pictures/food-2.png" alt="Position Absolute Acı Pizza" />
